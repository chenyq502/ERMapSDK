...
//  MapDemo
//
//  Created by KongPeng on 2018/7/7.
//  Copyright © 2018年 erlinyou. All rights reserved.
//

#import "UserLocationViewController.h"
#import <ERMapSDK/ERMapSDK.h>
@interface UserLocationViewController ()<ERMapViewDelegate>
...
- (void)createUI
{
    ...
    UIView *myLocationControl = [self createSingleViewWithTag:0 text:@"myLocationEnabled"];
...
- (UIView *)createSingleViewWithTag:(NSInteger )tag text:(NSString *)text;
{
    ...
    sw.tag = tag;
    sw.on = self.mapView.myLocationEnabled;
...
{
    self.mapView.myLocationEnabled = sw.on;
}

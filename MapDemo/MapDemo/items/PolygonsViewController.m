...
//  MapDemo
//
//  Created by KongPeng on 2018/12/28.
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    ERCameraPosition *camera = [ERCameraPosition cameraWithTarget:CLLocationCoordinate2DMake(39.13006,-77.508545) zoom:4 viewingAngle:0];
...
- (void)viewDidLoad {
    ...
    ERPolygon *polygon = [[ERPolygon alloc] init];
    polygon.path = [self pathOfNewYorkState];
    polygon.holes = @[[self pathOfNewYorkStateHole]];
    polygon.fillColor = [UIColor colorWithRed:63.0/255.0 green:0 blue:0 alpha:0.2f];
    polygon.strokeColor = [UIColor blackColor];
    polygon.strokeWidth = 5;
    polygon.tappable = YES;
    polygon.map = self.mapView;
    
    ERPolygon *polygon2 = [[ERPolygon alloc] init];
    polygon2.path = [self pathOfNorthCarolina];
    polygon2.fillColor = [UIColor colorWithRed:0 green:0.25 blue:0 alpha:0.5];
    polygon2.strokeColor = [UIColor blackColor];
    polygon2.strokeWidth = 5;
    polygon2.tappable = YES;
    polygon2.map = self.mapView;
    
}

- (ERPath *)pathOfNewYorkState {
    ERMutablePath *path = [[ERMutablePath alloc] init];
